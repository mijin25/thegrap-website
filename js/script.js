...
function initHeroCarousel() {
    ...
    let isManualTransition = false; // 수동 전환 여부 추적
    ...
    function nextSlide() {
        ...
        isManualTransition = true; // 수동 전환 플래그 설정
        showSlide(nextIndex);
    }
...
function initMobileMenu() {
    ...
    if (mobileMenuLogo) {
        mobileMenuLogo.addEventListener('click', function(e) {
            ...
            console.log('모바일 메뉴 로고 클릭 - 홈으로 이동');
        });
        
        // 로고를 클릭 가능하도록 커서 스타일 추가
        mobileMenuLogo.style.cursor = 'pointer';
    }
